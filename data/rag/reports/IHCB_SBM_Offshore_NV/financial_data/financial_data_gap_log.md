# Financial Data Gap Log: SBM Offshore NV

**Ticker (Bloomberg):** IHCB  
**Ticker (Yahoo Finance):** SBMO.AS  
**ISIN:** NL0000360618  
**Sector:** Energy  
**Country:** NL  
**Company folder:** data/rag/reports/IHCB_SBM_Offshore_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (318pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IHCB_SBM_Offshore_NV/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (308pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IHCB_SBM_Offshore_NV/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_quality_regulatory_policy_2025.pdf (1pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IHCB_SBM_Offshore_NV/company_reports/tier1_quality_regulatory_policy_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (SBMO.AS) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `SBMO.AS` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("SBMO.AS", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "SBM Offshore NV annual report 2024 PDF investor relations"
  "SBM Offshore NV financial statements 2024"
  site:ihcb.com annual report 2024
...
Valuation multiples:
  "SBM Offshore NV EV EBITDA 2024 valuation"
  "SBM Offshore NV PE ratio 2024"
  "IHCB trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `SBMO.AS` has sufficient price overlap with EXW1.DE
