# Financial Data Gap Log: Games Workshop Group PLC

**Ticker (Bloomberg):** G7W  
**Ticker (Yahoo Finance):** GAW.L  
**ISIN:** GB0003718474  
**Sector:** Consumer Discretionary  
**Country:** GB  
**Company folder:** data/rag/reports/G7W_Games_Workshop_Group_PLC/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (104pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/G7W_Games_Workshop_Group_PLC/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (93pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/G7W_Games_Workshop_Group_PLC/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_gender_pay_gap_report_2025.pdf (5pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/G7W_Games_Workshop_Group_PLC/company_reports/tier1_gender_pay_gap_report_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (GAW.L) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `GAW.L` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("GAW.L", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Games Workshop Group PLC annual report 2024 PDF investor relations"
  "Games Workshop Group PLC financial statements 2024"
  site:g7w.com annual report 2024
...
Valuation multiples:
  "Games Workshop Group PLC EV EBITDA 2024 valuation"
  "Games Workshop Group PLC PE ratio 2024"
  "G7W trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `GAW.L` has sufficient price overlap with EXW1.DE
