# Financial Data Gap Log: Gaztransport Et Technigaz SA

**Ticker (Bloomberg):** 9TG  
**Ticker (Yahoo Finance):** GTT.PA  
**ISIN:** FR0011726835  
**Sector:** Energy  
**Country:** FR  
**Company folder:** data/rag/reports/9TG_Gaztransport_Et_Technigaz_SA/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier2_sustainability_report_2024.pdf (84pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/9TG_Gaztransport_Et_Technigaz_SA/company_reports/tier2_sustainability_report_2024.pdf | — |
| tier1_ethics_charter_2025.pdf (74pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/9TG_Gaztransport_Et_Technigaz_SA/company_reports/tier1_ethics_charter_2025.pdf | — |
| tier1_professional_equality_index_2025.pdf (2pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/9TG_Gaztransport_Et_Technigaz_SA/company_reports/tier1_professional_equality_index_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (GTT.PA) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `GTT.PA` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("GTT.PA", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Gaztransport Et Technigaz SA annual report 2024 PDF investor relations"
  "Gaztransport Et Technigaz SA financial statements 2024"
  site:9tg.com annual report 2024
...
Valuation multiples:
  "Gaztransport Et Technigaz SA EV EBITDA 2024 valuation"
  "Gaztransport Et Technigaz SA PE ratio 2024"
  "9TG trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `GTT.PA` has sufficient price overlap with EXW1.DE
