# Financial Data Gap Log: BE Semiconductor Industries NV

**Ticker (Bloomberg):** BSI  
**Ticker (Yahoo Finance):** BESI.AS  
**ISIN:** NL0012866412  
**Sector:** Technology  
**Country:** NL  
**Company folder:** data/rag/reports/BSI_BE_Semiconductor_Industries_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_sustainability_statement_2025.pdf (82pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/BSI_BE_Semiconductor_Industries_NV/company_reports/tier1_sustainability_statement_2025.pdf | — |
| tier2_sustainability_statement_2024.pdf (80pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/BSI_BE_Semiconductor_Industries_NV/company_reports/tier2_sustainability_statement_2024.pdf | — |
| tier1_annual_report_2025.pdf (266pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/BSI_BE_Semiconductor_Industries_NV/company_reports/tier1_annual_report_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (BESI.AS) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `BESI.AS` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("BESI.AS", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "BE Semiconductor Industries NV annual report 2024 PDF investor relations"
  "BE Semiconductor Industries NV financial statements 2024"
  site:bsi.com annual report 2024
...
Valuation multiples:
  "BE Semiconductor Industries NV EV EBITDA 2024 valuation"
  "BE Semiconductor Industries NV PE ratio 2024"
  "BSI trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `BESI.AS` has sufficient price overlap with EXW1.DE
