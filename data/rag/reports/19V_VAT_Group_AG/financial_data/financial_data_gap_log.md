# Financial Data Gap Log: VAT Group AG

**Ticker (Bloomberg):** 19V  
**Ticker (Yahoo Finance):** VACN.SW  
**ISIN:** CH0311864901  
**Sector:** Industrials  
**Country:** CH  
**Company folder:** data/rag/reports/19V_VAT_Group_AG/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_sustainability_report_2025.pdf (103pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/19V_VAT_Group_AG/company_reports/tier1_sustainability_report_2025.pdf | — |
| tier2_sustainability_report_2024.pdf (104pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/19V_VAT_Group_AG/company_reports/tier2_sustainability_report_2024.pdf | — |
| tier1_annual_report_2025.pdf (176pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/19V_VAT_Group_AG/company_reports/tier1_annual_report_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (VACN.SW) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `VACN.SW` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("VACN.SW", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "VAT Group AG annual report 2024 PDF investor relations"
  "VAT Group AG financial statements 2024"
  site:19v.com annual report 2024
...
Valuation multiples:
  "VAT Group AG EV EBITDA 2024 valuation"
  "VAT Group AG PE ratio 2024"
  "19V trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `VACN.SW` has sufficient price overlap with EXW1.DE
