# Financial Data Gap Log: STMicroelectronics NV

**Ticker (Bloomberg):** SGM  
**Ticker (Yahoo Finance):** STM  
**ISIN:** IT0001029492  
**Sector:** Technology  
**Country:** IT  
**Company folder:** data/rag/reports/SGM_STMicroelectronics_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (469pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SGM_STMicroelectronics_NV/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (442pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SGM_STMicroelectronics_NV/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_sustainability_at_a_glance_2025.pdf (28pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SGM_STMicroelectronics_NV/company_reports/tier1_sustainability_at_a_glance_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (STM) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `STM` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("STM", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "STMicroelectronics NV annual report 2024 PDF investor relations"
  "STMicroelectronics NV financial statements 2024"
  site:sgm.com annual report 2024
...
Valuation multiples:
  "STMicroelectronics NV EV EBITDA 2024 valuation"
  "STMicroelectronics NV PE ratio 2024"
  "SGM trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `STM` has sufficient price overlap with EXW1.DE
