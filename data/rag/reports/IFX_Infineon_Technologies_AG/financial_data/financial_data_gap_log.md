# Financial Data Gap Log: Infineon Technologies AG

**Ticker (Bloomberg):** IFX  
**Ticker (Yahoo Finance):** IFX.DE  
**ISIN:** CA4524352099*  
**Sector:** Technology  
**Country:** DE  
**Company folder:** data/rag/reports/IFX_Infineon_Technologies_AG/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_sustainability_report_2025.pdf (120pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IFX_Infineon_Technologies_AG/company_reports/tier1_sustainability_report_2025.pdf | — |
| tier2_sustainability_report_2024.pdf (81pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IFX_Infineon_Technologies_AG/company_reports/tier2_sustainability_report_2024.pdf | — |
| tier1_annual_report_2025.pdf (192pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/IFX_Infineon_Technologies_AG/company_reports/tier1_annual_report_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (IFX.DE) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `IFX.DE` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("IFX.DE", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Infineon Technologies AG annual report 2024 PDF investor relations"
  "Infineon Technologies AG financial statements 2024"
  site:ifx.com annual report 2024
...
Valuation multiples:
  "Infineon Technologies AG EV EBITDA 2024 valuation"
  "Infineon Technologies AG PE ratio 2024"
  "IFX trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `IFX.DE` has sufficient price overlap with EXW1.DE
