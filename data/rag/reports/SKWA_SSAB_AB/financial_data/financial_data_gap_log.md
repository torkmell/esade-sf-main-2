# Financial Data Gap Log: SSAB AB

**Ticker (Bloomberg):** SKWA  
**Ticker (Yahoo Finance):** SSAB-B.ST  
**ISIN:** SE0000171100  
**Sector:** Materials  
**Country:** SE  
**Company folder:** data/rag/reports/SKWA_SSAB_AB/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (189pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SKWA_SSAB_AB/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (197pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SKWA_SSAB_AB/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_anticorruption_directive_2025.pdf (2pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/SKWA_SSAB_AB/company_reports/tier1_anticorruption_directive_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (SSAB-B.ST) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `SSAB-B.ST` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("SSAB-B.ST", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "SSAB AB annual report 2024 PDF investor relations"
  "SSAB AB financial statements 2024"
  site:skwa.com annual report 2024
...
Valuation multiples:
  "SSAB AB EV EBITDA 2024 valuation"
  "SSAB AB PE ratio 2024"
  "SKWA trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `SSAB-B.ST` has sufficient price overlap with EXW1.DE
