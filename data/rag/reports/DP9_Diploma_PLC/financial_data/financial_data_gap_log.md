# Financial Data Gap Log: Diploma PLC

**Ticker (Bloomberg):** DP9  
**Ticker (Yahoo Finance):** DPLM.L  
**ISIN:** GB0001826634  
**Sector:** Industrials  
**Country:** GB  
**Company folder:** data/rag/reports/DP9_Diploma_PLC/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_sustainability_report_2025.pdf (4pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/DP9_Diploma_PLC/company_reports/tier1_sustainability_report_2025.pdf | — |
| tier2_sustainability_report_2024.pdf (5pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/DP9_Diploma_PLC/company_reports/tier2_sustainability_report_2024.pdf | — |
| tier1_annual_report_and_accounts_2025.pdf (172pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/DP9_Diploma_PLC/company_reports/tier1_annual_report_and_accounts_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (DPLM.L) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `DPLM.L` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("DPLM.L", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Diploma PLC annual report 2024 PDF investor relations"
  "Diploma PLC financial statements 2024"
  site:dp9.com annual report 2024
...
Valuation multiples:
  "Diploma PLC EV EBITDA 2024 valuation"
  "Diploma PLC PE ratio 2024"
  "DP9 trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `DPLM.L` has sufficient price overlap with EXW1.DE
