# Financial Data Gap Log: Ferrari NV

**Ticker (Bloomberg):** 2FE  
**Ticker (Yahoo Finance):** RACE.MI  
**ISIN:** NL0011585146  
**Sector:** Consumer Discretionary  
**Country:** IT  
**Company folder:** data/rag/reports/2FE_Ferrari_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (514pp — image-heavy) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/2FE_Ferrari_NV/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (478pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/2FE_Ferrari_NV/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_tcfd_cross_reference_table_2025.pdf (3pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/2FE_Ferrari_NV/company_reports/tier1_tcfd_cross_reference_table_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (RACE.MI) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `RACE.MI` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("RACE.MI", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Ferrari NV annual report 2024 PDF investor relations"
  "Ferrari NV financial statements 2024"
  site:2fe.com annual report 2024
...
Valuation multiples:
  "Ferrari NV EV EBITDA 2024 valuation"
  "Ferrari NV PE ratio 2024"
  "2FE trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `RACE.MI` has sufficient price overlap with EXW1.DE
