# Financial Data Gap Log: ASM International NV

**Ticker (Bloomberg):** AVS  
**Ticker (Yahoo Finance):** ASM.AS  
**ISIN:** NL0000334118  
**Sector:** Technology  
**Country:** NL  
**Company folder:** data/rag/reports/AVS_ASM_International_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_compressed_2025.pdf (249pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/AVS_ASM_International_NV/company_reports/tier1_annual_report_compressed_2025.pdf | — |
| tier2_annual_report_2024.pdf (217pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/AVS_ASM_International_NV/company_reports/tier2_annual_report_2024.pdf | — |
| tier1_cdp_climate_change_response_2025.pdf (430pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/AVS_ASM_International_NV/company_reports/tier1_cdp_climate_change_response_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (ASM.AS) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `ASM.AS` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("ASM.AS", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "ASM International NV annual report 2024 PDF investor relations"
  "ASM International NV financial statements 2024"
  site:avs.com annual report 2024
...
Valuation multiples:
  "ASM International NV EV EBITDA 2024 valuation"
  "ASM International NV PE ratio 2024"
  "AVS trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `ASM.AS` has sufficient price overlap with EXW1.DE
