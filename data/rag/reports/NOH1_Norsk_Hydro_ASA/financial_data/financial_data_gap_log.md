# Financial Data Gap Log: Norsk Hydro ASA

**Ticker (Bloomberg):** NOH1  
**Ticker (Yahoo Finance):** NHY.OL  
**ISIN:** NO0005052605  
**Sector:** Materials  
**Country:** NO  
**Company folder:** data/rag/reports/NOH1_Norsk_Hydro_ASA/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_integrated_annual_report_2025.pdf (307pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/NOH1_Norsk_Hydro_ASA/company_reports/tier1_integrated_annual_report_2025.pdf | — |
| tier2_integrated_annual_report_2024.pdf (283pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/NOH1_Norsk_Hydro_ASA/company_reports/tier2_integrated_annual_report_2024.pdf | — |
| tier1_cdp_climate_change_forest_and_water_2025.pdf (409pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/NOH1_Norsk_Hydro_ASA/company_reports/tier1_cdp_climate_change_forest_and_water_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (NHY.OL) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `NHY.OL` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("NHY.OL", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Norsk Hydro ASA annual report 2024 PDF investor relations"
  "Norsk Hydro ASA financial statements 2024"
  site:noh1.com annual report 2024
...
Valuation multiples:
  "Norsk Hydro ASA EV EBITDA 2024 valuation"
  "Norsk Hydro ASA PE ratio 2024"
  "NOH1 trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `NHY.OL` has sufficient price overlap with EXW1.DE
