# Financial Data Gap Log: Argenx SE

**Ticker (Bloomberg):** 1AE  
**Ticker (Yahoo Finance):** ARGX.BR  
**ISIN:** NL0010832176  
**Sector:** Health Care  
**Country:** NL  
**Company folder:** data/rag/reports/1AE_Argenx_SE/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_2025.pdf (335pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/1AE_Argenx_SE/company_reports/tier1_annual_report_2025.pdf | — |
| tier2_annual_report_2024.pdf (384pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/1AE_Argenx_SE/company_reports/tier2_annual_report_2024.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (ARGX.BR) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `ARGX.BR` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("ARGX.BR", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "Argenx SE annual report 2024 PDF investor relations"
  "Argenx SE financial statements 2024"
  site:1ae.com annual report 2024
...
Valuation multiples:
  "Argenx SE EV EBITDA 2024 valuation"
  "Argenx SE PE ratio 2024"
  "1AE trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `ARGX.BR` has sufficient price overlap with EXW1.DE
