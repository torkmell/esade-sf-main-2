# Financial Data Gap Log: ASML Holding NV

**Ticker (Bloomberg):** ASME  
**Ticker (Yahoo Finance):** ASML.AS  
**ISIN:** NL0010273215  
**Sector:** Technology  
**Country:** NL  
**Company folder:** data/rag/reports/ASME_ASML_Holding_NV/  
**Created:** 2026-05-16  
...
|------|------|--------|-----------|-------|
| tier1_annual_report_based_on_ifrs_2025.pdf (354pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/ASME_ASML_Holding_NV/company_reports/tier1_annual_report_based_on_ifrs_2025.pdf | — |
| tier2_annual_report_based_on_us_gaap_2024.pdf (410pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/ASME_ASML_Holding_NV/company_reports/tier2_annual_report_based_on_us_gaap_2024.pdf | — |
| tier1_tcfd_report_climate_related_disclosures_2025.pdf (10pp) | Annual/Sustainability Report | FY2024/2025 | data/rag/reports/ASME_ASML_Holding_NV/company_reports/tier1_tcfd_report_climate_related_disclosures_2025.pdf | — |
...
|-----------|------------------|----------------|-----------------|----------------|---------|-------|
| 1Y / 3Y / 5Y price return | return_1y, return_3y, return_5y | TO BE COLLECTED | yfinance (ASML.AS) | — | HIGH | Run fetch_price_data_template.py |
...
- [ ] Price data: yfinance ticker `ASML.AS` — run `fetch_price_data_template.py`
...
```
Price data:
  yfinance: yf.download("ASML.AS", start="2020-01-01", end="2025-01-01")

Annual report (if not already in company_reports/):
  "ASML Holding NV annual report 2024 PDF investor relations"
  "ASML Holding NV financial statements 2024"
  site:asme.com annual report 2024
...
Valuation multiples:
  "ASML Holding NV EV EBITDA 2024 valuation"
  "ASML Holding NV PE ratio 2024"
  "ASME trailing PE EV EBITDA"
```
...
- [ ] Confirm beta is not NaN — if NaN, check whether yf_ticker `ASML.AS` has sufficient price overlap with EXW1.DE
